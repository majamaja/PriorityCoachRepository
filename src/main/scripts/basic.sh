...
curl -H "Content-Type: application/json" -H "Authorization: $authToken" -d '{"deleted": ["lifeUpgradeActions": ["54df4e07-b6bf-4571-8eac-208bbb0e4433"]]}' "$baseUrl/v1/sync/user" | jq
