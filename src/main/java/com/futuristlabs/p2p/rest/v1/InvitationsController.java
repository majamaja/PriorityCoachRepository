...
public class InvitationsController {
    ...
    public BuddyInvitationStatus inviteBuddy(
        ...
        final String invitationToken = invitations.create(userId, invitation);
    ...
    public void acceptInvitation(
        ...
        if (!invitations.accept(userId, invitationToken)) {
            throw new RestException(HttpStatus.NOT_FOUND, "Invitation token not found");
        }
    }
    ...
    public void rejectInvitation(
        ...
        if (!invitations.reject(userId, invitationToken)) {
            throw new RestException(HttpStatus.NOT_FOUND, "Invitation token not found");
        }
    }
