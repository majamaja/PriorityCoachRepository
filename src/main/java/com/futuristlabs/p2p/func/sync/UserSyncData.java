...
public class UserSyncData {
    ...
    public static abstract class AbstractUserSyncData<LIFE_UPGRADE_ACTIONS, USER_ACTION_ITEMS, USER_ACTIONS_LOG, USER_HAPPINESS_LEVEL, USER_FRIENDS, USER_FRIEND_PERMISSION, USER_NOTES> {
        public List<LIFE_UPGRADE_ACTIONS> lifeUpgradeActions;
        public List<USER_ACTION_ITEMS> userActionItems;
        ...
        public List<USER_NOTES> userNotes;

        public boolean isEmpty() {
            return (lifeUpgradeActions == null || lifeUpgradeActions.isEmpty()) &&
                    (userActionItems == null || userActionItems.isEmpty()) &&
                    ...
                    (userNotes == null || userNotes.isEmpty());
        }

    }

    public static class UpdatedUserSyncData extends AbstractUserSyncData<LifeUpgradeAction, UserActionItem, UserActionsLog, HappinessLevel, UserFriend, UserFriendPermission, UserNotes> {

    }

    public static class DeletedUserSyncData extends AbstractUserSyncData<UUID, UUID, UUID, UUID, UUID, UUID, UUID> {

    }

    public static class FailedUserSyncData extends AbstractUserSyncData<UUID, UUID, UUID, UUID, UUID, UUID, UUID> {
