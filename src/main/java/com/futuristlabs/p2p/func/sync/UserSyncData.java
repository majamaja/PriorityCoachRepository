...
public class UserSyncData {
    ...
    public static abstract class AbstractUserSyncData<LIFE_UPGRADE_ACTIONS, USER_ACTIONS_LOG, USER_HAPPINESS_LEVEL, USER_FRIENDS, USER_FRIEND_PERMISSION, USER_NOTES> {
    ...
    public static class UpdatedUserSyncData extends AbstractUserSyncData<LifeUpgradeAction, UserActionsLog, HappinessLevel, UserFriend, UserFriendPermission, UserNotes> {

    }

    public static class DeletedUserSyncData extends AbstractUserSyncData<UUID, UUID, UUID, UUID, UUID, UUID> {

    }

    public static class FailedUserSyncData extends AbstractUserSyncData<UUID, UUID, UUID, UUID, UUID, UUID> {
